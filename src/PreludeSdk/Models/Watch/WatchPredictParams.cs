...
sealed class TypeConverter : JsonConverter<global::PreludeSdk.Models.Watch.Type>
{
    ...
    )
    {
        ...
        {
            "phone_number" => global::PreludeSdk.Models.Watch.Type.PhoneNumber,
            "email_address" => global::PreludeSdk.Models.Watch.Type.EmailAddress,
    ...
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::PreludeSdk.Models.Watch.Type.PhoneNumber => "phone_number",
                global::PreludeSdk.Models.Watch.Type.EmailAddress => "email_address",
