...
/// <summary>
/// Send transactional and marketing messages to your users via SMS, RCS and WhatsApp
...
/// </summary>
public record class NotifySendParams : ParamsBase
{
    ...
    /// <summary>
    /// The message expiration date in RFC3339 format. The message will not be sent
    ...
    /// can be scheduled up to 90 days in advance and will be automatically adjusted
    /// for compliance with local time window restrictions.
    /// </summary>
    ...
    public NotifySendParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public NotifySendParams(NotifySendParams notifySendParams)
        : base(notifySendParams)
    {
        this._rawBodyData = new(notifySendParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static NotifySendParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(NotifySendParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new System::UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v2/notify")
        {
...
/// <summary>
/// The preferred channel to be used in priority for message delivery. If the channel
/// is unavailable, the system will fallback to other available channels.
/// </summary>
