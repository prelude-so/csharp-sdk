...
namespace Prelude.Models.Lookup;
...
public record class LookupLookupParams : ParamsBase
{
    ...
    /// functionality.
    /// </summary>
    public IReadOnlyList<ApiEnum<string, global::Prelude.Models.Lookup.Type>>? Type
    {
        get
        {
            this._rawQueryData.Freeze();
            return this._rawQueryData.GetNullableStruct<
                ImmutableArray<ApiEnum<string, global::Prelude.Models.Lookup.Type>>
            >("type");
        }
        init
        {
            ...
            this._rawQueryData.Set<ImmutableArray<
                ApiEnum<string, global::Prelude.Models.Lookup.Type>
...
sealed class TypeConverter : JsonConverter<global::Prelude.Models.Lookup.Type>
{
    public override global::Prelude.Models.Lookup.Type Read(
    ...
    )
    {
        ...
        {
            "cnam" => global::Prelude.Models.Lookup.Type.Cnam,
            _ => (global::Prelude.Models.Lookup.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Prelude.Models.Lookup.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Prelude.Models.Lookup.Type.Cnam => "cnam",
