...
namespace Prelude.Models.Verification;
...
public sealed record class Target : JsonModel
{
    ...
    /// </summary>
    public required ApiEnum<string, global::Prelude.Models.Verification.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::Prelude.Models.Verification.Type>
            >("type");
        }
...
sealed class TypeConverter : JsonConverter<global::Prelude.Models.Verification.Type>
{
    public override global::Prelude.Models.Verification.Type Read(
    ...
    )
    {
        ...
        {
            "phone_number" => global::Prelude.Models.Verification.Type.PhoneNumber,
            "email_address" => global::Prelude.Models.Verification.Type.EmailAddress,
            _ => (global::Prelude.Models.Verification.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Prelude.Models.Verification.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Prelude.Models.Verification.Type.PhoneNumber => "phone_number",
                global::Prelude.Models.Verification.Type.EmailAddress => "email_address",
