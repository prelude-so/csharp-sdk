...
public record class VerificationManagementDeletePhoneNumberParams : ParamsBase
{
    ...
    public ApiEnum<
        string,
        global::Prelude.Models.VerificationManagement.Action
    >? Action { get; init; }
...
#pragma warning disable CS8618
    ...
    VerificationManagementDeletePhoneNumberParams(
        ...
        ApiEnum<string, global::Prelude.Models.VerificationManagement.Action> action
    )
    {
        this._rawHeaderData = new(rawHeaderData);
        this._rawQueryData = new(rawQueryData);
...
sealed class ActionConverter : JsonConverter<global::Prelude.Models.VerificationManagement.Action>
{
    public override global::Prelude.Models.VerificationManagement.Action Read(
    ...
    )
    {
        ...
        {
            "allow" => global::Prelude.Models.VerificationManagement.Action.Allow,
            "block" => global::Prelude.Models.VerificationManagement.Action.Block,
            _ => (global::Prelude.Models.VerificationManagement.Action)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Prelude.Models.VerificationManagement.Action value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Prelude.Models.VerificationManagement.Action.Allow => "allow",
                global::Prelude.Models.VerificationManagement.Action.Block => "block",
