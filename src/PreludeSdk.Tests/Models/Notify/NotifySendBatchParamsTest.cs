...
public class NotifySendBatchParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new NotifySendBatchParams
        {
        ...
        List<string> expectedTo = ["+33612345678", "+15551234567"];
        string expectedCallbackUrl = "https://your-app.com/webhooks/notify";
        string expectedCorrelationID = "campaign-12345";
        NotifySendBatchParamsDocument expectedDocument = new()
        {
    ...
    {
        NotifySendBatchParams parameters = new()
        {
            TemplateID = "template_01k8ap1btqf5r9fq2c8ax5fhc9",
            To = ["+33612345678", "+15551234567"],
        };
        ...
        Assert.True(TestBase.UrisEqual(new Uri("https://api.prelude.dev/v2/notify/batch"), url));
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        NotifySendBatchParams copied = new(parameters);

        Assert.Equal(parameters, copied);
    }
}

public class NotifySendBatchParamsDocumentTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new NotifySendBatchParamsDocument
        {
            Url = "https://example.com/invoice.pdf",
            Filename = "invoice.pdf",
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<NotifySendBatchParamsDocument>(
            json,
    ...
    {
        var model = new NotifySendBatchParamsDocument { Url = "https://example.com/invoice.pdf" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        NotifySendBatchParamsDocument copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class NotifySendBatchParamsPreferredChannelTest : TestBase
{
    [Theory]
    [InlineData(NotifySendBatchParamsPreferredChannel.Sms)]
    [InlineData(NotifySendBatchParamsPreferredChannel.Rcs)]
    [InlineData(NotifySendBatchParamsPreferredChannel.Whatsapp)]
    public void Validation_Works(NotifySendBatchParamsPreferredChannel rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, NotifySendBatchParamsPreferredChannel> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(NotifySendBatchParamsPreferredChannel.Rcs)]
    [InlineData(NotifySendBatchParamsPreferredChannel.Whatsapp)]
    public void SerializationRoundtrip_Works(NotifySendBatchParamsPreferredChannel rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, NotifySendBatchParamsPreferredChannel> value = rawValue;
